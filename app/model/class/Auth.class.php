...
class Auth {
    public static function createToken($PublicId, $SecretId, $RegisterDate): bool
    {
        ...
        $Token = new stdClass();
        $Token->public = file_get_contents("https://localhost/LojaVirtual/Config/Keys/Public.pem");
        $Token->private = file_get_contents("https://localhost/LojaVirtual/Config/Keys/Private.pem");
